...
values."
  (setq-default
   ...
   '(
     ...
     helm
     auto-completion
     (better-defaults :variables better-defaults-move-to-end-of-code-first t) ;; init layer variables
     emacs-lisp
     git
     markdown
     org
